...
export const cardsPricing = [
  {
    ...
    benefits: ['Basic Support', '500 Messages', 'Sales Insights', '1 Chatbot'],
    price: 0,
    logo: 'basic',
  },
  {
...
export const helpToggleData = [
  {
    ...
    text:
      'Godman offers unparalleled AI chatbot functionality, top-notch customer engagement, and an ever-evolving platform built for modern businesses.',
  },
  {
    heading: 'Is it secure?',
    text:
      'Absolutely! We prioritize security and confidentiality, adhering to the highest industry standards in data protection and user privacy.',
  },
  {
    heading: 'How difficult is setup?',
    text:
      "Setting up Godman's AI chatbot constructor is a breeze! Our intuitive user interface makes the process smooth and easy for businesses of all sizes.",
  },
  {
    heading: 'Which industries benefit?',
    text:
      "Godman's AI chatbot constructor is perfect for any industry, from retail and e-commerce to tech support and customer service. Your success is our priority!",
  },
];
